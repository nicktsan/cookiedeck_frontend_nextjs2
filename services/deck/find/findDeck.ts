...
import { DeckFindRequestSchema, DeckFindResponseDataSchema, DeckFindResponseSchema } from "./findDeckSchema";
...
export async function FindDeck(id: string): Promise<DeckFindResponseDataDTO> {
    ...
    const validated: DeckFindResponseDataDTO = validate(deckFindResponse.data, DeckFindResponseDataSchema, "DeckFindResponseDataSchema");
